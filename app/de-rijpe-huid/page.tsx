...
export default function DermatologistBlogPage() {
  return (
    <>
      {/* Header - now outside Layout for true top alignment */}
      <header className="bg-[#e9c7c0] w-full flex items-center justify-center border-b border-gray-200 min-h-[56px] p-0 m-0">
        <div className="flex items-center w-full max-w-4xl px-4 py-0 m-0">
